...
## Website Mockup 📱 💻 🖥️
![all-devices-black](https://user-images.githubusercontent.com/98527559/166136542-b3344226-711e-4176-8b81-0d5a0ab15847.png)
...
Check the live demo [here](https://mavericks-db.github.io/signupform/)👈
...
```
$ git clone git@github.com:mavericks-db/signupform.git
```
...
Feel free to check the [issues page](https://github.com/mavericks-db/signupform/issues).
